...
const AppointmentPage = () => {
  ...
  const [Confirmed, setConfirmed] = useState([]);
    ...
    //     const response = await axios.get(`http://afe62695a98434d1d82d98f959376357-1478653283.us-east-1.elb.amazonaws.com/api/get-all-appointments-staff/${outletId}`, {
      const response = await axios.get("http://afe62695a98434d1d82d98f959376357-1478653283.us-east-1.elb.amazonaws.com/api/get-all-appointments-staff", {
          // headers: {
    ...
    const fetchConfirmedAppointments = async () => {
      ...
      const response = await axios.get("http://afe62695a98434d1d82d98f959376357-1478653283.us-east-1.elb.amazonaws.com/api/get-all-appointments-staff-confirm", {
          // headers: {
          //   Authorization: `Bearer ${token.token}`,
          // },
        });
